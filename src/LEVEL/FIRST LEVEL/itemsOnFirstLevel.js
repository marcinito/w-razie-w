...
export const itemsOnFirstLevel=()=>{
    let array=[
        new glockItems(710,340,true),new Meat(100,0,true),new machineGunItems(300,0,true),new AxeItems(340,210,true),new AxeItems(370,210,true),
        ...
        new jumpFluidItems(650,210,true),new jumpFluidItems(650,210,true),new jumpFluidItems(200,200,true),new helperSpawnRuna(200,200,true,"left",0)]
    return array
}